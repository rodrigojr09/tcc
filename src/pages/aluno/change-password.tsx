        ...
        <div className="center-senha">
            <div className="card-senha">
                ...
                <div className="textfield">
                    ...
                    <input onChange={e=>setSenha(e.target.value)} value={senha} type="password"  name="Nova-senha" placeholder="Nova Senha" />
                </div>
                <div className="textfield">
                ...
                <button onClick={e=>enviar()} className="btn">Alterar Senha</button>
            </div>
        </div>
    </>
}